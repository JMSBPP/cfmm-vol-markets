...
- [ ] 02-04-PLAN.md — **REOPENED 2026-08-28**: the refactor was reverted at chunk review; edit list VOID, superseded by `02-REGRESSION-ASSESSMENT.md` §4a — the refactor: `VolOrder(T)` in 4 files only, `comptime T` on the tokenId path only, harness surface frozen; gate green with 02-01's counts, floor 10/10 untouched, differential still skips, stamp selector set identical (VORD-01/02/03)
...
| 2. VolOrder(T) Minimal Instantiation | 3/5 | In progress (02-04 reopened) | 2026-08-28 |
