...
| [#139 define/CEVStateRunner success path (one index)](https://github.com/JMSBPP/cfmm-vol-markets/issues/139) | `define` | CI pending | `1b8ac24`; [push-build 35905068558](https://github.com/JMSBPP/cfmm-vol-markets/actions/runs/35905068558); [PR #142](https://github.com/JMSBPP/cfmm-vol-markets/pull/142) |
