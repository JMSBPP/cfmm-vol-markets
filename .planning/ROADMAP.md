...
| [#139 define/CEVStateRunner success path (one index)](https://github.com/JMSBPP/cfmm-vol-markets/issues/139) | `define` | In progress | [PR #142](https://github.com/JMSBPP/cfmm-vol-markets/pull/142); ledger `139-define-cev-state-runner-success/PLANK-STATE.md` |
