...
| [#147 define/CEVStateRunner B2 RunJ](https://github.com/JMSBPP/cfmm-vol-markets/issues/147) | `define` | In progress | Grill locked; Eff `[StateView,Timestamp]`; #148 absorbed; sibling #151 |
