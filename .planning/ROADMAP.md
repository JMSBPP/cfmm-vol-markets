...
- [ ] 28-03-PLAN.md — Publication: `write_bytes_atomically` generalized from the existing JSON writer, the textual identity splice that keeps the artifact's bytes verbatim, the shape floor, and the ten-second race harness with its torn-read positive control OBSERVED (LOOP-03) [wave 3]
...
| 28. Resident Loop & Fixture Publication (S1/S2/S3 closed; LOOP-01 proven 28-02; live half BLOCKED on #26) | 2/5 | In Progress | - |
