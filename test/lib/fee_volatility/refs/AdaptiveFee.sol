...
// contracts/libraries/AdaptiveFee.sol (installed as a dev dep; this copy is the differential-test
// oracle). The ONLY changes vs upstream: pragma relaxed from `=0.8.20` to `>=0.8.0` for the test
// compile, and the UNUSED `import Constants.sol` line removed (it is never referenced in the body and
// its contracts/-style path does not resolve in forge's node_modules compile context). The algorithm
// -- getFee / sigmoid / expXg4 -- is verbatim.
pragma solidity >=0.8.0;

import '@cryptoalgebra/dynamic-fee-plugin/types/AlgebraFeeConfiguration.sol';
import '@cryptoalgebra/dynamic-fee-plugin/types/AlgebraFeeConfigurationU144.sol';
