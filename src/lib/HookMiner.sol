...
/// @dev Vendored verbatim (modulo the Hooks import path, which is remapped to this repo's
/// vendored v4-core) from Uniswap/v4-hooks-public @ 8207003b461a15fa07a3aa1c03dd1a70554c6736,
/// src/utils/HookMiner.sol (MIT). Vendored rather than added as a submodule because
/// v4-hooks-public pulls 13 nested submodules -- including the Optimism monorepo, ~1.2GB --
/// which the develop gate's `git submodule update --init --recursive` would re-clone on
/// every run.
library HookMiner {
